...
export function CreateCv() {
    ...
    try {
      ...
      if (selectedFile) {
        try {
          ...
          setUploadError("Le CV a été créé, mais l'envoi de la photo a échoué.");
        }
      }
  ...
  // Le CV n'existe pas encore : on complète id/enCours avec des valeurs
  // temporaires (utilisées uniquement pour l'aperçu visuel, jamais envoyées au backend).
